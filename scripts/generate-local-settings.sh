...
AZURE_OPENAI_SMALL_CHATGPT_DEPLOYMENT="${env_vars[AZURE_CHAT_GPT_SMALL_DEPLOYMENT_NAME]:-}"
AZURE_OPENAI_SMALL_CHATGPT_MODEL="${env_vars[AZURE_CHAT_GPT_SMALL_MODEL_NAME]:-}"
...
jq -n \
    ...
    --arg openai_small_chat_deployment "$AZURE_OPENAI_SMALL_CHATGPT_DEPLOYMENT" \
    --arg openai_small_chat_model "$AZURE_OPENAI_SMALL_CHATGPT_MODEL" \
...
'{
  ...
  "Values": {
    ...
    "AZURE_OPENAI_SMALL_CHATGPT_MODEL": $openai_small_chat_model,
    "AZURE_OPENAI_SMALL_CHATGPT_DEPLOYMENT": $openai_small_chat_deployment,
...
echo "AZURE_OPENAI_SMALL_CHATGPT_MODEL:   ${AZURE_OPENAI_SMALL_CHATGPT_MODEL:-(not set)}"
echo "AZURE_OPENAI_SMALL_CHATGPT_DEPLOYMENT: ${AZURE_OPENAI_SMALL_CHATGPT_DEPLOYMENT:-(not set)}"
echo "-------------------------------"
